...
// 		$res8=mysqli_query($con,$sql8);
       ...
       $sql3=mysqli_query($con, "INSERT INTO `tbl_roombook`(`hid`,`uid`,`hname`,`checkin`,`checkout`,`name`,`address`,`phone`,`wantedrooms`,`type`,`payment`,`status`) VALUES('$hotelid','$userid','$hotelname','$date1','$date2','$name','$addresss','$phone','$count1','$type1','succes','0')");
			 ...
			 $sql10="update tbl_pic set d3='$hotelname' where uid='$userid' and d3='no'";
  ...
  echo "<script>alert('succeesfuly Booked!');window.location.href='../individual.php';</script>";
	...
	{
	echo "<script>alert(' Paiment not succeesfuly!');window.location.href='cidthree.php';</script>";
	}
}			
	?>
