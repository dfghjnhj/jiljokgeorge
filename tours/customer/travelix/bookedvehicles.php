				...
				<div class="container fill_height no-padding">
					<div class="row fill_height no-margin">
						<div class="col fill_height no-padding">
							...
							<!-- Search Panel -->
							<h6>tables</h6><br><br>
							<button type="button"  class="btn btn-default" ><a href="bookedvehicles.php">BUS BOOKING</a></button>	<button type="button"  class="btn btn-default" ><a href="boookedtraveler.php">TRAVELLER</a></button><br><br>
							<h6><b> <i> MY BUS BOOKINGS</i><b></h6>
                   ...
                   ?>
						<tbody>
						 ...
						 <td width="20%">
																	...
																	<td width="20%">
																	<button><a href="cancelbus.php?idb=<?php echo $idb; ?> && from=<?php echo $from; ?>">cancel</button></td>
