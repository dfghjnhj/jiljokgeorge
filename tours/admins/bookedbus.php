...
<input type="text" id="myInput" placeholder="Search" title="Type in a name"></div>		
		<div class="chute chute-center text-center">
				...
				include("database.php");
					$sql="SELECT * FROM `tbl_vehiclebooking` where payment='succes'";
        ...
        <tr>
						...
						<th>number</th>
            <th>from</th>
            <th data-breakpoints="xs">to</th>
            <th data-breakpoints="xs">destination</th>
            <th data-breakpoints="xs">root</th>
        
            <th data-breakpoints="xs">arrival</th>
            <th data-breakpoints="xs">phone</th>
						<th data-breakpoints="xs">payment</th>
						<th data-breakpoints="xs">AFTER TRIP</th>
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
                    ...
                    echo "<tr><td><centre>$name</centre></td><td><centre>$d[bname]</centre></td><td><centre>$d[bnumber]</centre></td><td><centre>$from</centre></td><td><centre>$to</centre></td><td><centre>$destination</centre></td><td><centre>$root</centre></td><td><centre>$arrival</centre></td><td><centre>$phone</centre></td><td><centre>$payment</centre></td><td><centre><button type='button'><a href='afterpayment.php?id=$vid'><b>AFTER TRIP</b></a></button>
										</td></centre></td><td>";		
