                ...
                <nav class="navbar navbar-expand-lg navbar-light rounded">
                    ...
                    <div class="navbar-collapse collapse w-100" id="navbar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="grounds.php" ><br>Grounds</a>
                            <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="views.php"><br>View</a>
                            
                            <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="gallery.php"><br>Image</a>
                               <?php
...
if($rowcount !=0 )
	{	
		while($row=mysqli_fetch_array($result))
		{
			...
			echo "<tr><td>$gname<td>$email<td><center><input type='submit' value='view' name='submit' style='color:blue; border-radius:5px ' ></center>";
			echo"<input type='hidden' value='$email' name='id'>";
			echo"<input type='hidden' value='$bid' name='b_id'>";
			echo"</form>";
