...
$i++;
	...
	//print_r($a);                 
            ...
            for ($i=0; $i <sizeof($a) ; $i++) {
							...
							echo  "<h3> date :".$a[$i]."   ----------------------avilable rooms :".$b[$i]."<br>"."</h3>";
							if($b[$i] < $s)
                                                                          {
                                                                            $s=$b[$i];
                                                                          }
			...
			?>
                            ...
                            <form action="web/roompayment.php" method="post">
									<div class="search_item">
										<div>check in</div>
										<input type="text" name="datefirst" id="datefirst" value="<?php echo $d1; ?>"  required="required" readonly>
									</div>
								
									<div class="extras">
										<div class="search_item">
										<div>check out</div>
										<input type="text" name="datesecond" id="datesecond"  value="<?php echo $d2; ?>" required="required" readonly>
                                    </div>
                                    <div class="extras">
										<div class="search_item">
										<div> rooms</div>
                                        <select class=""  name="type" id="roomCount" required="required">
                                    ...
                                    <div class="extras">
										...
										<div class="search_item">
										<div>name</div>
										<input type="text"   name="name" id="name" pattern="^[A-Za-z]+$" title="Alphabets Only" required="required">
									</div>
										<div class="extras">
										<div class="search_item">
										<div>address</div>
									...
									<div class="extras">
										<div class="search_item">
										<div>phone</div>
										<input type="text" name="phone" id="phone" pattern="[2-9]{2}\d{8}" title="Enter a ten digit number"  required="required">
                                    </div>
