...
<div class="super_container">
	...
	<!-- Home -->
				...
				<div class="pbars_accordions">
					<div class="row">
						<div class="col-lg-12">
							<div class="elements_title">DAILY PROGRAME </div>
        ...
        ?>
								...
								<div class="elements_accordions">
									...
									<div class="accordion_container">
										...
										<button type="button" class="btn btn-warning"><a href="hoteldetail2.php?hotel=<?php echo $twohotel; ?> && from=<?php echo $from1; ?> && to=<?php echo $to1; ?>"><b>BOOKING</b></a></button>
										</div>
										...
										<button type="button" class="btn btn-danger"><a href="hoteldetail2.php?hotel=<?php echo $threehotel; ?> && from=<?php echo $from2; ?> && to=<?php echo $two2; ?>"><b>BOOKING</b></a></button>
										</div>
										<div class="accordion_container">
									...
									ACCOMADATION WITH PACKAGES :<b><u><i><?php echo $fourc; ?></i></b></u></p>
										...
										<button type="button" class="btn"><a href="hoteldetail2.php?hotel=<?php echo $fourhotel; ?> && from=<?php echo $from3; ?> && to=<?php echo $to3; ?>"><b>BOOKING</b></a></button>
										</div>
