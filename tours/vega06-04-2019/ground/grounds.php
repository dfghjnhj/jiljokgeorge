...
echo '											<a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="grounds.php" ><br>Ground</a>
...
';										
									...
									{ ?>
                            <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="grounds.php" onClick="this.removeAttribute('href');"><br>Ground</a>
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item" href="profile.php">Profile</a></li>
                                     <li><a class="dropdown-item" href="ground1.php">MY Ground</a></li>
...
<div class="contact-section overview-bgi">
            ...
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                    ...
                    <div >
                        ...
                        <br>
                        <!-- Form start -->
                         <form action="graction.php" method="POST" enctype="multipart/form-data">
               
                            <div class="form-group">
                                <input type="text" name="gname" class="input-text" placeholder="Ground Name">
                            </div>
                            <div class="form-group">
                            <textarea rows="4" cols="50" name="gaddress" class="input-text" placeholder="Address"></textarea>
                            </div>
    ...
    function ShowHideDiv() {
        ...
        dvPassport.style.display = chkYes.checked ? "block" : "none";
                            ...
                            <div class="form-group">
                            <input type="radio" name="seats" value="Yes"   id="chkYes" name="chkPassPort" onclick="ShowHideDiv()" > Yes &nbsp; &nbsp;
                            <input type="radio" name="seats" value="No" id="chkNo" name="chkPassPort" onclick="ShowHideDiv()"> No
                            </div>
                            <div class="form-group" id="dvPassport" style="display: none">
                                <input type="text" name="sno" class="input-text" placeholder="Seat Number" id="txtPassportNumber">
                            </div>
                            <div class="form-group">
