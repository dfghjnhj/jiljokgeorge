...
if(isset($_POST['pay']))
{
	...
	$seat=$bookedRooms-1;
     ...
     $suc=mysqli_query($con,"INSERT INTO `tbl_pbin`(`uid`,`package`,`pid`,`person`,`address`,`phone`,`payment`) VALUES('$user','$package','$pakid','$m1','$maddress','$mphone','notsucces')");
...
{	
	...
	while($row=mysqli_fetch_array($result))
       ...
       $sql3="update tbl_pbin set payment='succes' where phone='$phone' and pid='$id'";
  ...
  echo "<script>alert('succeesfuly Booked!');window.location.href='../inditourbook.php';</script>";
