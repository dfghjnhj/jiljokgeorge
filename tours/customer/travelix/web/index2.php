...
if(isset($_POST['pay']))
{
    ...
    $name=$_POST['name'];
     ...
     $suc=mysqli_query($con,"INSERT INTO `tbl_vehiclebooking`(`bid`,`uid`,`name`,`fromone`,`toone`,`destination`,`root`,`arrival`,`mphone`,`payment`,`status`,`advance`) VALUES('$idss','$user','$name','$from','$to','$destination','$root','$arrival','$mphone','not complete','0','0')");
}
...
{	
	...
	while($row=mysqli_fetch_array($result))
		...
		{
			echo $amount;
			echo "<script>alert('not suffient balance!;');window.location.href='../index2.php';</script>";
		}
else
	      {
		$amt=$amount1-$amount;
       ...
       $sql3="update tbl_vehiclebooking set payment='succes',advance='$amount' where mphone='$phone'";
  ...
  echo "<script>alert('succeesfuly Booked!');window.location.href='../bookedvehicles.php';</script>";
	...
	{
	echo "<script>alert(' Paiment not succeesfuly!');window.location.href='index2.php';</script>";
	}
}			
	?>
		<div class="main">
