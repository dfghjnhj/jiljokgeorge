			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<div class="contact_title text-center">Name   :<?php echo $name; ?>  </div>
						<div class="contact_title text-center">Address:<?php echo $address; ?></div>
						<div class="contact_title text-center">Gender  :<?php echo $gender; ?></div>
						<div class="contact_title text-center">Phone  :<?php echo $phone; ?></div>
						<div class="contact_title text-center">Email  :<?php echo $email; ?></div>
