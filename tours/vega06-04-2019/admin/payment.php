            ...
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                    ...
                    <div  style="color:#FFFFFF">
                        ...
                        <br>
                        <!-- Form start -->
                        <table class="table" style="margin-left:300" ui-jq="footable" ui-options='{
        "paging": {
          "enabled": true
        },
        "filtering": {
...
$amount=$row['amount'];
 echo "<form >";
			echo "<tr><td><centre>$email</centre></td><td><centre>$ba_name</centre></td><td><centre>$amount</centre></td></tr>";
			echo"</form>";
