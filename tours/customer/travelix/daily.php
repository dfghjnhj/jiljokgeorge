				...
				<div class="pbars_accordions">
					<div class="row">
						...
						<button type="button" class="btn btn-default" >we offer tour packages with accomadation and also provide<br> customized hotel bookings,
							...
							<div class="elements_title">Book tour frist <button type="button" class="btn btn-default" ><a href="familycastumized.php?name=<?php echo $name; ?> && id=<?php echo $id; ?>">BOOK</a></button> </div>
		...
		while($row=mysqli_fetch_array($result))
		{
            ...
            $acco=$row['oneac'];
                    ...
                    <div class="accordion_container">
                        ...
                        <button type="button" class="btn btn-default" ><a href="hotelinfo.php?hotel=<?php echo $hotel; ?> && from=<?php echo $from; ?> && to=<?php echo $to; ?>"><b>BOOKING</b></a></button>
                    ...
                    if($two!=null)
                    {
                        ?>
                                    ...
                                    <button type="button" class="btn btn-warning"><a href="hotelinfo2.php?hotel=<?php echo $twohotel; ?> && from=<?php echo $from1; ?> && to=<?php echo $to1; ?>"><b>BOOKING</b></a></button>
                                    </div>
                                    <?php
                    }
                    ?>
                    ...
                    if($three!=null)
                    {
                    	...
                    	<div class="accordion_container">
										...
										<button type="button" class="btn btn-danger"><a href="hotelinfo3.php?hotel=<?php echo $threehotel; ?> && from=<?php echo $from2; ?> && to=<?php echo $two2; ?>"><b>BOOKING</b></a></button>
										</div>
                                        <?php
                    }
                    ?>
                    ...
                    if($four!=null)
                    {
                    	...
                    	<div class="accordion_container">
									...
									ACCOMADATION WITH PACKAGES :<b><u><i><?php echo $fourc; ?></i></b></u></p>
										...
										<button type="button" class="btn"><a href="hotelinfo4.php?hotel=<?php echo $fourhotel; ?> && from=<?php echo $from3; ?> && to=<?php echo $to3; ?> "><b>BOOKING</b></a></button>
										</div>
										<?php
                    }
                    ?>
