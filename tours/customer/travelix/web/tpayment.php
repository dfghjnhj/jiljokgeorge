...
{	
	...
	while($row=mysqli_fetch_array($result))
		...
		if($amount1<$total)
		{
			echo "<script>alert('not suffient balance!');window.location.href='tpayment.php';</script>";
		}
else
	      {
		$amt=$amount1-$amount;
        ...
        $sql5="update tbl_travelerbook set payment='fullpayment' where uid='$id' and fromone='$from' and toone='$to'";
  ...
  echo "<script>alert('succeesfuly Booked!');window.location.href='../travelerreport.php';</script>";
	...
	{
	echo "<script>alert(' Paiment not succeesfuly!');window.location.href='tpayment.php';</script>";
	}
}			
	?>
