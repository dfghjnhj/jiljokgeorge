...
<div class="inner-block">
    <div class="cols-grids panel-widget">
		...
		<button type="button" class="btn btn-default"><a href=fc.php><b>customized booking</b></a></button><br>
		
			<?php
				include("database.php");
					$sql="SELECT * FROM `tbl_pb` where payment='succes'";
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
					...
					echo " <button type=button class=btn btn-danger><a href=tbook.php?name=$name><b>$name</b></a></button>";		
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
                    ...
                    echo "<tr><tbody ><td><centre>$name</centre></td><td><centre>$m1,$m2,$m3,$m4,$m5</centre></td><td><centre>$address</centre></td><td><centre>$mphone</centre></td><td>";		
