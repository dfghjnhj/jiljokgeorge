...
<!-- Mirrored from rn53themes.net/themes/demo/lava-admin/hotel-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Apr 2019 03:41:19 GMT -->
<head>
        ...
        <div class="row">
            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-add-blog sb2-2-1">
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="list-name" type="text" class="validate" name="name">
                                                <label for="list-title">Name</label>
                                            </div>
                                            <div class="input-field col s12">
                                                <input id="list-name" type="text" class="validate" name="city">
                                                <label for="list-name">City</label>
                                            </div>
											 <div class="input-field col s3">
                                                <select name="country"  id="country" required="required" palceholder="Your Country">
                        <?php
                    ...
                    <div class="input-field col s3">        
                    <select name="state" id="state" required=""  palceholder="Your State"></select>
                    </div>
                    <script >
                            ...
                            $.ajax({
                                ...
                                success: function (data)
                                {
                                    ...
                                    $("#dist").html(data);
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="list-name" type="text" class="validate" name="address">
                                                <label for="list-title">address</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                < <input id="list-name" type="text" class="validate" name="landmark">
                                                <label for="list-title">landmark</label>
                                            </div>
                                        </div>
                                        <div class="row">
