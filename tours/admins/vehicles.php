   ...
   <div class="boost-icons">
		  ...
		  <div class="boost-icons-bottom">
				<div class="boost-icons-list">
					<ul>
						<li><img src="coach-3206326__340.png" width="100" height="100"><button class="btn btn-info"><a href="addbus.php"> ADD BUS</a></button></li>
						<li><img src="download (3).jpg" width="100" height="100"> <button class="btn btn-info"><a href="addtrav.php">ADD TRAVELLERS</a></li>
						<!--<li><img src="download (4).jpg" width="100" height="100"><button class="btn btn-info"><a href="addcars.php"> ADD CAR</li>-->
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-cogs"></i><span>vehicles</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="vehicles.php">Add vehicles</a></li>
		            <li><a href="viewbus.php">view registerd bus</a></li>	
								<li><a href="viewtraveler.php">view registerd Traveler</a></li>		    
