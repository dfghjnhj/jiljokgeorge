...
{	
	...
	while($row=mysqli_fetch_array($result))
        ...
        $sql5="update tbl_vehiclebooking set payment='fullpayment' where uid='$id' and fromone='$from' and toone='$to'";
  ...
  echo "<script>alert('succeesfuly paid!');window.location.href='../billreport.php';</script>";
	...
	{
	echo "<script>alert(' Paiment not succeesfuly!');window.location.href='../billreport.php';</script>";
	}
}			
	?>
