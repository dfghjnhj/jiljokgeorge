...
<input type="text" id="myInput" placeholder="Search" title="Type in a name"></div>		
		<div class="chute chute-center text-center">
				...
				include("database.php");
					$sql="SELECT * FROM `tbn_registration`";
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
				  ...
				  echo "<tr><td><centre>$name</centre></td><td><centre>$address</centre></td><td><centre>$gender</centre></td><td><centre>$phone</centre></td><td><centre>$email</centre></td></td><td>";		
