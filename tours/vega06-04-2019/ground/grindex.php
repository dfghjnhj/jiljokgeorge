...
';										
									...
									{ ?>
                            <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="ground.php" onClick="this.removeAttribute('href');"></br>Ground</a>
...
<option value="1000">1000</option>
                         ...
                         <div class="footer">
                        <a href="grbooknon.php" style="color:#FF0000">Not Now</a>
                    </div>
                        <!-- Social List -->
