...
<div class="inner-block">
    <div class="cols-grids panel-widget">
		<button type="button" class="btn btn-default"><a href=familybook.php><b>Booking</b></a></button>
		<button type="button" class="btn btn-default"><a href=viewpak.php><b>customized booking</b></a></button>
			<h2>BOOKING DETAILS</h2>
            <?php
				include("database.php");
					$sql="SELECT * FROM `tbl_fcp` where payment='succes'";
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
					...
					echo " <button type=button class=btn btn-danger><a href=tbookcus.php?name=$name><b>$name</b></a></button>";		
...
<div>
<input type="text" id="myInput" placeholder="Search for names.." title="Type in a name"></div>
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
                    ...
                    echo "<tr><tbody ><td><centre>$name</centre></td><td><centre>$m1,$m2,$m3,$m4,$m5</centre></td><td><centre>$d1,$d2,$d3,$d4</centre></td><td><centre>$address</centre></td><td><centre>$mphone</centre></td><td>";		
