...
<input type="text" id="myInput" placeholder="Search" title="Type in a name"></div>		
		<div class="chute chute-center text-center">
				...
				include("database.php");
					$sql="SELECT * FROM `tbl_addtraveler`";
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
					...
					$desi=$row['tnumber'];
					$bdetails=$row['tdetails'];
                    $seat=$row['tseat'];
                    $fa=$row['tfacilities'];	
					$coast=$row['tcoast'];
                    $bimage=$row['timage'];
                  
										echo "<tr><td><centre>$name</centre></td><td><centre>$desi</centre></td><td><centre>$seat</centre></td><td><centre>$coast</centre></td><td><centre><img src=$bimage; width=100 height=100></centre></td></td><td>";		
