 ...
 if(isset($_POST["submit"]))
 {
    ...
    $tseat=$_POST["tseat"];
		...
		$target_dir = "uploads/";
					...
					//	$target_filess = $target_dir . basename($_FILES["tcerer"]["name"]);
					//	move_uploaded_file($_FILES["tcerer"]["tmp_name"], $target_filess);
    $suc=mysqli_query($con,"INSERT INTO `tbl_addtraveler`(`tname`,`tnumber`,`tfacilities`,`tseat`,`tcoast`,`tdetails`,`timage`,`district`) VALUES('$tname','$tnumber','$tdetails','$tseat','$tcoast','$tac','$target_files','$dis')");
      //  header("location:index.php");
				//echo print_r($suc);
			
				header("location:viewtraveler.php");
 }
	?>
					...
					<div class="inbox-details-default">
						...
						<div class="inbox-details-body">
							...
							<form class="com-mail" action="#" method="POST" enctype="multipart/form-data">
								...
								<input type="text" name="tname"  class=" form-control av-name" av-message=" only name" placeholder="vehicle name" required="">  
                                <input type="text" name="tnumber" placeholder="number" required="">  
								<input type="text"  name="tdetails"  class=" form-control av-name" av-message=" only name"  placeholder="details" required="">
								photo of vehicles
								<input type="file" name="timage"> <br><br><br>
								<input type="text" name="tseat" placeholder="no of seats" class=" form-control av-image" av-message="only image" required="">  
							
							   <!--vehicle documentations-permit certificate
								 <input type="file" name="tcerer"><br>-->
								 facilities<br>
								 <input type="radio" name="ac" value="ac" required="" >ac<input type="radio" name="ac" value="nonac" required="" >non ac<br><br>
							
								 <input type="text" name="tcoast" placeholder="cost per kilometer" class=" form-control av-posnumber"  av-message="number" required="">  
