...
if(isset($_POST['pay']))
{
	...
	$sqlone="select seat from `tbn_addpak` where pname='$package'";
	...
	$seat=$bookedRooms-1;
     ...
     $suc=mysqli_query($con,"INSERT INTO `tbl_pb`(`pname`,`m1`,`m2`,`m3`,`m4`,`m5`,`maddress`,`mphone`,`payment`) VALUES('$package','$m1','$m2','$m3','$m4','$m5','$maddress','$mphone','notsucces')");
	 $sql5="update tbn_addpak set seat='$seat' where pname='$package'";
