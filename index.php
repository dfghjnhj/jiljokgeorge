  ...
  if($rowcount !=0 )
	...
	?>
			<h1><?php echo $name; ?></h1> 
								...
								<div class="intro_price"><h2><?php echo $landmark; ?></h2></div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offer_name"><a href="#"><?php echo $name; ?></a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price"><?php echo "$".$cost; ?><span>per night</span></div>
