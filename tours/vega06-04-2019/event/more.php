...
echo '											<a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="evbook.php" ><br>Book</a>
...
';										
									...
									{ ?>
                            <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="evbook.php" onClick="this.removeAttribute('href');"><br>Book</a>
...
$result=mysqli_query($con,$sql);
	...
	<div class="matches-main-agileinfo">
		...
		<div class="col-lg-12 person-info-agileits-w3layouts">
        
			
             <div class="form-group">
            <h6> NAME</h6>                                <input type="text" name="gname" class="input-text" value="<?php echo $gname;?>" disabled="disabled">
                            </div>
                          <div class="form-group">
                   <h6>ADDRESS</h6>             <input type="text" name="gname" class="input-text" value="<?php echo $gaddress;?>" disabled="disabled">
                            </div>
                             <div class="form-group">
                   <h6>SEATS</h6>             <input type="text" name="gname" class="input-text" value="<?php echo $seats;?>" disabled="disabled">
                            </div>
                             <div class="form-group">
                       <h6>AMOUNT</h6>         <input type="text" name="gname" class="input-text" value="<?php echo $amount;?>" disabled="disabled">
                            </div>  
				<div class="form-group">
               <h6>ITEMS</h6>
                  <select name="type" >
        ...
        <input type="hidden" value="<?php echo $gid;?>" name="name">
  			<input class="sim-button button12" type="submit" id="m" value="BOOK" name="more" style="background-color:#FF0000"></br>
              </form>
               <?php } ?>
                        <!-- Social List -->
