...
if($rowcount !=0 )
	...
	{	$rc = 1;
		while($row=mysqli_fetch_array($result))
		{
            ...
            $di=$row['di'];
            $premium=$row['delux'];
            $premiump=$row['deluxprice'];
            $premiumfaci=$row['premium'];
            $pi=$row['premiumprice'];
            $b=$row['fac'];
            $bp=$row['pi'];
            $bf=$row['fa'];
    	...
    	<div class="col-md-3 product-grid">
    		<div class="product-items">
	    		...
	    		<div class="produ-cost">
                    ...
                    <h5><?php echo $landmark; ?></h5>
                   
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal"><a href="moreinfo.php?name=<?php echo $name; ?>">More info</button>
                </div>
