...
<div class="super_container">
	...
	<!--	<div class="container">
		...
		include("database.php");
			$sql="SELECT * FROM `tbn_addpak`where ptype='Honeymoon'";
...
<button type="button" class="btn btn-primary"><a href="inclusviness.php?id=<?php echo $id; ?>"><b>INCLUSIVNESS</b></a></button>
									...
									<div class="col-lg-3 text-lg-right">
										<div class="room_button">
											<div class="button book_button trans_200"><a href="#">BOOK NOW<span></span><span></span><span></span></a></div>
										</div>
									</div>
								</div>	
							</div>
