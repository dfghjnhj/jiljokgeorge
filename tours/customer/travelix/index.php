					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="bookedvehicles.php">my vehicle bookings</a></li>
								<li class="main_nav_item"><a href="familytourbooking.php">my family tour bookings</a></li>
								<li class="main_nav_item"><a href="inditourbook.php">my individual tours bookings</a></li>
								<li class="main_nav_item"><a href="roombook.php">booked rooms</a></li>
								<li class="main_nav_item"><a href="billreport.php">bill</a></li>
					...
					<!--<div class="search_panel active">
						<form action="#" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							<div class="search_item">
								<div>destination</div>
								<input type="text" class="destination search_input" name="search" required="required">
							</div>
							<!--<div class="search_item">
								<div>check in</div>
