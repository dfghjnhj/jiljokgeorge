...
<div class="contact-section overview-bgi">
 ...
 <h6>WHO</h6>
                           <div class="form-group">
                                <input type="text" name="gname" disabled="disabled" class="input-text" value="<?php echo $gname;?>" >
                            </div>
                            <h6>NAME</h6>
                            <div class="form-group">
                                <input type="text" name="fdate" disabled="disabled" class="input-text" value="<?php echo $fdate;?>" >
                            </div>
                             <h6>EMAIL</h6>
                            <div class="form-group">
                                <input type="text" name="tdate" disabled="disabled" class="input-text" value="<?php echo $tdate;?>" >
                            </div>
          
                            <h6>GENDER</h6>
                           <div class="form-group">
                            <input type="text" name="time" disabled="disabled" class="input-text" value="<?php echo $time;?>" >
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="b_id"  class="input-text" value="<?php echo $b_id;?>" >
                            </div>
                           <h6>MOBILE</h6>
                            
                            <div class="form-group">
                            <input type="text" name="type" disabled="disabled" class="input-text" value="<?php echo $type;?>" >
