...
// 	      {
  ...
  echo "<script>alert('succeesfuly Booked!');window.location.href='../roombook.php';</script>";
...
// }
	...
	{
	echo "<script>alert(' Paiment not succeesfuly!');window.location.href='roompayment.php';</script>";
	}
}			
	?>
