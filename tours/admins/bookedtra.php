...
<input type="text" id="myInput" placeholder="Search" title="Type in a name"></div>		
		...
		<div class="chute chute-center text-center">
				...
				include("database.php");
					$sql="SELECT * FROM `tbl_travelerbook` where payment='succes'";
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
				while($row=mysqli_fetch_array($result))
				{
                    ...
                    echo "<tr><td><centre>$name</centre></td><td><centre>$d[tname]</centre></td><td><centre>$d[tnumber]</centre></td><td><centre>$from</centre></td><td><centre>$to</centre></td><td><centre>$destination</centre></td><td><centre>$root</centre></td><td><centre>$arrival</centre></td><td><centre>$phone</centre></td><td><centre>$payment</centre></td><td><centre><button type='button'><a href='aftertrip.php?id=$tid'><b>AFTER TRIP</b></a></button>
										</td></centre></td><td>";		
