					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="inditourbook.php">my individual tour bookings</a></li>
							</ul>
						</div>
...
<div class="room">
	...
	<!-- Room -->
		...
		include("database.php");
			$sql="SELECT * FROM `tbn_addpak`where ptype='individual' && seat>0";
        ...
        ?>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										...
										<button type="button" class="btn btn-default" ><a href="more2.php?id=<?php echo $id; ?> && name=<?php echo $name; ?>"><b>MORE DETAILS</b></a></button><br><br>
									</div>
									<div class="col-lg-7">
										...
										<div  border-style: solid>
											...
											<div class="room_text"><?php echo $coast.":per PERSON"; ?></div>
...
<div class="btn-group" align="center">
  ...
  <button type="button"><a href="hi.php?id=<?php echo $id; ?> && name=<?php echo $name; ?>"><b>BOOKING WITH CUSTOMIZATION</b></a></button>
									...
									<div class="col-lg-3 text-lg-right">
										<div class="room_button">
											<div class="button book_button trans_200"><a href="individualpassenger.php?name=<?php echo $name; ?> && id=<?php echo $id; ?>">BOOKING WITH OUT HOTEL CUSTOMIZATION<span></span><span></span><span></span></a></div>
										</div>
										</div>
									</div>
								</div>	
