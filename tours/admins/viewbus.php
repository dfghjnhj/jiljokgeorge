				...
				while($row=mysqli_fetch_array($result))
				{
					...
					<table>
													...
													<td width="10%">
																	...
																	<td width="10%">
																	<?php echo $bdetails; ?></td>
																	<td width="10%">
																	 <?php echo $seat; ?>  seat
																	</td>
																
																	</td><td width="10%">
																	<img src="<?php echo $bimage; ?>" width="150" height="150">
...
<div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><span>vehicles</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
