		...
		<div class="container">
			<div class="login-body">
				...
				<div class="login-info">
					<form action="login_action.php" method="POST" onsubmit="return" class="oh-autoval-form">
					<?php 
						if(isset($_SESSION['r'] ))
						{
					...
					?>
						<input type="text" class="form-control av-email" av-message="Please enter registerd email id" name="username" placeholder="Email" required="">
						<input type="password" name="password"  class="form-control av-password" av-message="enter your password" name="password" placeholder="password" required="">
						
						<div class="forgot-top-grids">
							<div class="forgot-grid">
								<ul>
									<li>
										 <?php echo "INVALID CREADENTIALS"; ?>
