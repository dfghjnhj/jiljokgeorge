    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div  style='margin-left:900px;'class="col-md-2 col-sm-3 col-xs-6">
                <!-- Dropdown Trigger -->
                <a class='waves-effect dropdown-button top-user-pro' href='logout.php' data-activates='top-menu'>Log out<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                </a>
            ...
            <div class="sb2-2">
               ...
               <!-- <div class="sb2-2-3">
				...
				include("database.php");
					$sql="SELECT * FROM `tbl_roombook` where hid='$hid' and type='premium'";
