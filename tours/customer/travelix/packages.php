				...
				<div class="col fill_height">
					...
					<div class="search_tabs_container">
						<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							...
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/departure.png" alt=""><a href="hotel.php">hotels</a></div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section_title"><?php echo $name."  HOTEL"; ?></h2>
					<div><button class="btn btn-success"><?php echo $city; ?></button></div>
					<div><button class="btn btn-success"><?php echo $address; ?></button></div>
				</div>
			</div>
				...
				<div class="col-lg-6 offers_col">
					<div class="offers_item">
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price"><?php echo "$".$bc; ?><span>per night</span></div>
									<div class="rating_r rating_r_4 offers_rating">
										<i></i>
										<i></i>
										<i></i>
