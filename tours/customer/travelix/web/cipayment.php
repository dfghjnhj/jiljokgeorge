...
if(isset($_POST['pay']))
{
	...
	$seat=$bookedRooms-1;
     ...
     $suc=mysqli_query($con,"INSERT INTO  `tbl_pic`(`uid`,`package`,`pid`,`person`,`address`,`d1`,`d2`,`d3`,`d4`,`phone`,`payment`) VALUES('$user','$package','$pakid','$m1','$maddress','no','no','no','no','$mphone','notsucces')");
...
{	
	...
	while($row=mysqli_fetch_array($result))
		...
		if($amount1<$amount)
		{
			echo "<script>alert('not suffient balance!');window.location.href='../index1.php';</script>";
		}
else
	      {
		$amt=$amount1-$amount;
       ...
       $sql3="update tbl_pic set payment='succes' where phone='$phone' and pid='$id'";
         $res3=mysqli_query($con,$sql3);
         $sql5="update tbn_addpak set seat='$abseat' where pid='$id'";
  ...
  echo "<script>alert('succeesfuly Booked!');window.location.href='../indicbookingf.php';</script>";
	...
	{
	echo "<script>alert(' Paiment not succeesfuly!');window.location.href='index1.php';</script>";
	}
}			
	?>
                    ...
                    <option value="sib">sib</option>
					 ...
					 <option value="canara">icici</option>
												...
												<div class="tab-for">				
													...
													<h5>CARD NUMBER</h5>													
														<input type="text" name="c_no" class="input-text" placeholder="enter 12 digit number" required="">
												</div>	
