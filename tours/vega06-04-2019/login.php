...
<!-- Mirrored from storage.googleapis.com/themevessel-items/biznex/main/login.html by   [XR&CO'2014], Tue, 12 Feb 2019 05:07:13 GMT -->
<head>
    <!-- Google Tag Manager -->
                    ...
                    <div class="details">
                        ...
                        <form action="loginaction.php" method="post">
                            <div class="form-group">
                                <input type="email" name="email" class="input-text" id="email" placeholder="Email Address">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" class="btn-md btn-block btn btn-color">login</button>
                            </div>
                        </form>
                        <!-- Social List -->
