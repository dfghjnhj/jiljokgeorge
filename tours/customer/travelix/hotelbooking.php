    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Modal Header</h4>
			...
			<P>rooms avilable:<?php echo $br; ?></p>
      <div class="modal-body">
        <p>Check in date:<?php echo $from; ?></p>
				<p>Check out date:<?php echo $to; ?></p>
				<p> No of rooms<select name="type">
					...
					<div class="offers_item">
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									<!-- Image by https://unsplash.com/@kensuarez -->
									<div><img src="../../hotel/dorne/<?php echo $pi; ?>" width="300" height="300"></div>
							...
							<div class="col-lg-6">
								<div class="offers_content">
									...
									<div class="offers_link"><button class="btn btn-info">BOOK NOW</button></div>
							</div>
								</div>
							</div>
						</div>
					...
					<div class="offers_item">
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									<!-- Image by https://unsplash.com/@kensuarez -->
									<div class="offers_image_background"><img src="../../hotel/dorne/<?php echo $bi; ?>" width="300" height="300"></div>
