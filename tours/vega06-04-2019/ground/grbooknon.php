                    ...
                    <div >
                        ...
                        <!-- Form start -->
                         <form action="graction.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                            <input type="radio" name="seats" value="Yes" checked> Yes &nbsp; &nbsp;
                            <input type="radio" name="seats" value="No"> No
                            </div>
                            <div class="form-group">
                                <input type="text" name="sno" class="input-text" placeholder="Seat Number">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" class="btn-md btn-block btn btn-color"><a href="grindex.php">Submit</button>
                            </div>
                        </form>
                        <!-- Social List -->
