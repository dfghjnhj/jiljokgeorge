	...
	<div class="about">
		<div class="about-heading">
			<div class="container">
				...
				<p class="wow fadeInUp animated" data-wow-delay=".5s">Our company based on the focus about travel and tourisam</p>
			</div>
		</div>
		<div class="about-top">
			<div class="container">
				<div class="about-bottom">
					...
					<p class="wow fadeInUp animated" data-wow-delay=".5s">this is an big travel company</p>
				</div>
			</div>
		</div>
