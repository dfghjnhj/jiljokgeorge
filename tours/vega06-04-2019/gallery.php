                ...
                <nav class="navbar navbar-expand-lg navbar-light rounded">
                    ...
                    <div class="navbar-collapse collapse w-100" id="navbar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="index.php">Index</a>
                                <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="gallery.php">Gallery</a>
                                <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="login.php">Login</a>
                                <a class="btn btn-sm btn-white-sm-outline btn-round signup-link" href="register.php">Signup</a>
                            </li>
                        </ul>
                    </div>
                </nav>
...
$sql="select imagess from images";
...
while($row=mysqli_fetch_array($res))
		{
		$imagess=$row['imagess'];
		 echo '<img src="data:image/jpeg;base64,'.base64_encode($imagess ).'"  width="300"  height="400" style="margin-left:10px">';
		}
	}
	?>
