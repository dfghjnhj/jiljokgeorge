				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="images/logo.png" alt="">Tour</a></div>
						</div>
				...
				<div class="col fill_height">
					...
					<div class="search_tabs_container">
						<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt=""><span><a href="pak.php">packages</a></span></div>
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/bus.png" alt=""><a href="searchbyvehicles.php">vehicles</div>
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/stats_1.png" alt=""><a href="search.php">hotels</a></div>
					...
					<div class="search_panel active">
						<form action="hoteldetails.php" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start" method="post">
							<div class="search_item">
								<div>search by place</div>
								<input type="text" class="destination search_input" name="search" required="required"><br><br>
								<button class="btn btn-primary"><input type="submit" name="submit" value="Search"></button>
							</div>
							<!--<div class="search_item">
								<div>check in</div>
