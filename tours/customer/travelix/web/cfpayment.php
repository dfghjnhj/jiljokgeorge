...
if(isset($_POST['pay']))
{
 ...
 $seat=$bookedRooms-1;
     ...
     $suc=mysqli_query($con,"INSERT INTO `tbl_fcp`(`pname`,`pid`,`uid`,`m1`,`m2`,`m3`,`m4`,`m5`,`maddress`,`d1`,`d2`,`d3`,`d4`,`mphone`,`payment`) VALUES('$package','$pakid','$user','$m1','$m2','$m3','$m4','$m5','$maddress','no','no','no','no','$mphone','notsucces')");
...
{	
	...
	while($row=mysqli_fetch_array($result))
       ...
       $sql3="update tbl_fcp set payment='succes' where mphone='$phone'";
  ...
  echo "<script>alert('succeesfuly Booked!');window.location.href='../pak.php';</script>";
	...
	{
	echo "<script>alert(' Paiment not succeesfuly!');window.location.href='cfpayment.php';</script>";
	}
}			
	?>
