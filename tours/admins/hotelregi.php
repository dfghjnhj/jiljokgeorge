		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><!--<i class="fa fa-envelope"></i>--><span>packages</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         ...
		         <li><a href="#"><!--<i class="fa fa-cog"></i>--><span>bus</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
			            <li id="menu-academico-avaliacoes" ><a href="addbus.php">add bus</a></li>
