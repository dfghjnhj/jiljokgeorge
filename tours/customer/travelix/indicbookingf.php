				...
				<div class="container fill_height no-padding">
					<div class="row fill_height no-margin">
						<div class="col fill_height no-padding">
							...
							<!-- Search Panel -->
							<h6>tables</h6><br><br>
							<button type="button"  class="btn btn-default" ><a href="inditourbook.php">BOOKING</a></button>	<button type="button"  class="btn btn-default" ><a href="indicbookingf.php">BOOKING WITH CUSTOMIZED ACCOMADATION</a></button><br><br>
							<h6><b> <i> MY INDIVIDUAL CUSTOMIZED TOUR BOOKING</i><b></h6>
...
tr:nth-child(even) {
  background-color: #dddddd;
               ...
               $sql="SELECT * FROM `tbl_pic` where uid='$user' and status='0'";
               $result=mysqli_query($con,$sql);
                   ...
                   <th data-breakpoints="xs" width="20%">Tourist name</th> 	
		...
		if($rowcount !=0 )
			...
			{	$rc = 1;
              ...
              <td width="20%">
																...
																<button><a href="indicancel.php?id=<?php echo $pbid; ?> && from=<?php echo $from; ?>">cancel</button></td>
