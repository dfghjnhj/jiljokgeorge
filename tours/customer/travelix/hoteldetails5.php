								...
								<div class="col-lg-6">
									<div class="offers_content">
										...
										<!--<div class="offers_icons">
														...
														<button type="button" class="btn btn-warning" ><a href="searchhotel5.php?id=<?php echo $hdid; ?> && name=<?php echo $name; ?> && type=delux">Book</a></button>
														</div>
				...
				<div class="offers_item">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<button type="button" class="btn btn-warning" ><a href="searchhotel5.php?id=<?php echo $hdid; ?> && name=<?php echo $name; ?> && type=premium">Book</a></button>
				...
				<div class="offers_item">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<button type="button" class="btn btn-warning" ><a href="searchhotel5.php?id=<?php echo $hdid; ?> && name=<?php echo $name; ?> && type=budget">Book</a></button>
							</div>
					</div>
