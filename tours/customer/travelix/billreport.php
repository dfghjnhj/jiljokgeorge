...
tr:nth-child(even) {
  background-color: #dddddd;
				  ...
				  include("database.php");
					  ...
					  $sql="SELECT * FROM `tbl_bill` where uid='$user' and type='bus'";
					  $result=mysqli_query($con,$sql);
					  ?>
					  <tr>
		            <th data-breakpoints="xs" width="20%">DEATAILS</th>
		            <th data-breakpoints="xs" width="20%">BALANCE REPORT</th>
			...
			{	$rc = 1;
               ...
               ?>
				 ...
				 cost: <?php echo $cost; ?> per kilometer<br>
				  ...
				  <td width=20%>
				  <input type="button" class="w3-btn w3-teal"><a href="pdf.php?id=<?php echo $billid; ?>">REPORT</a></button>
				</td>
				  <td width=20%>
																	<?php
