					...
					<div class="inbox-details-default">
						...
						<div class="inbox-details-body">
							...
							<form class="com-mail" action="#" method="POST" enctype="multipart/form-data">                      
								<input type="text" name="pname" placeholder="vehicle name" required="">  
                                <input type="text" name="pname" placeholder="number" required="">  
								<input type="text"  name="pdestination" placeholder="facilities" required="">
								photo of vehicles
								<input type="file" name="image"> <br><br><br>
                                <input type="text" name="pname" placeholder="no of seats"  required="">
							   vehicle documentations-permit certificate
								 ...
								 <input type="text" name="pname" placeholder="cost per kilometer" required="">  
