...
<?php
 ...
 if(isset($_POST["submit"]))
 {
    ...
    $suc=mysqli_query($con,"INSERT INTO `tbl_bus`(`btype`,`bname`,`bnumber`,`bdetails`,`bseat`,`bcoast`,`ac`,`bsleeper`,`bimage`,`bcerti`) VALUES('$btype','$bname','$bnumber','$bdetails','$bseat','$bcoast','$bac','$bsleeper','$target_file','$target_fileone')");
					...
					<div class="inbox-details-default">
						...
						<div class="inbox-details-body">
                            ...
                            customized hotel booking
                                             <input type="date" placeholder="search by place" name="from"> 
                                             <input type="date" placeholder="search by place" name="to"> <br>
                                             <div>
                                             <select name="country"  id="country" palceholder="Your Country" class="form-control">
                                            <?php
